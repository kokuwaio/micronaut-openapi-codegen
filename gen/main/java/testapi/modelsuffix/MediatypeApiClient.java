...
public interface MediatypeApiClient {
	...
	io.micronaut.http.HttpResponse<StringModelVO> mediatypeConsumesAndProduces(
	...
	io.micronaut.http.HttpResponse<MultipartVO> mediatypeConsumesMultipartWithFileUpload(
			@io.micronaut.core.annotation.NonNull
			@io.micronaut.http.annotation.Body
	...
	@io.micronaut.http.annotation.Produces({ "application/octet-stream" })
	@io.micronaut.http.annotation.Consumes({ "application/json" })
	io.micronaut.http.HttpResponse<StringModelVO> mediatypeConsumesOctetStream(
			@io.micronaut.core.annotation.NonNull
			@io.micronaut.http.annotation.Body
			byte[] body);
	...
	@io.micronaut.http.annotation.Consumes({ "application/json" })
	io.micronaut.http.HttpResponse<StringModelVO> mediatypeConsumesPlain(
			@io.micronaut.core.annotation.NonNull
			@io.micronaut.http.annotation.Body
	...
	io.micronaut.http.HttpResponse<StringModelVO> mediatypeProducesSameModel(
			@io.micronaut.core.annotation.NonNull
			@io.micronaut.http.annotation.QueryValue(value = "value")
			java.lang.String value);
}
