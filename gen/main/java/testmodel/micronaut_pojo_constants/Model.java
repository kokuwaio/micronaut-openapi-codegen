...
public class Model {
	...
	@com.fasterxml.jackson.annotation.JsonInclude(com.fasterxml.jackson.annotation.JsonInclude.Include.NON_ABSENT)
	private org.openapitools.jackson.nullable.JsonNullable<java.util.List<java.lang.@jakarta.validation.constraints.NotNull String>> nullableArray = org.openapitools.jackson.nullable.JsonNullable.undefined();

	@com.fasterxml.jackson.annotation.JsonProperty(JSON_PROPERTY_NULLABLE_SET)
	@com.fasterxml.jackson.annotation.JsonInclude(com.fasterxml.jackson.annotation.JsonInclude.Include.NON_ABSENT)
	private org.openapitools.jackson.nullable.JsonNullable<java.util.Set<java.lang.@jakarta.validation.constraints.NotNull String>> nullableSet = org.openapitools.jackson.nullable.JsonNullable.undefined();
	...
	public Model nullableArray(org.openapitools.jackson.nullable.JsonNullable<java.util.List<java.lang.@jakarta.validation.constraints.NotNull String>> newNullableArray) {
	...
	public Model addNullableArrayItem(java.lang.String nullableArrayItem) {
		if (this.nullableArray == null || !this.nullableArray.isPresent()) {
			this.nullableArray = org.openapitools.jackson.nullable.JsonNullable.<java.util.List<java.lang.@jakarta.validation.constraints.NotNull String>>of(new java.util.ArrayList<>());
		}
	...
	public Model nullableSet(org.openapitools.jackson.nullable.JsonNullable<java.util.Set<java.lang.@jakarta.validation.constraints.NotNull String>> newNullableSet) {
	...
	public Model addNullableSetItem(java.lang.String nullableSetItem) {
		if (this.nullableSet == null || !this.nullableSet.isPresent()) {
			this.nullableSet = org.openapitools.jackson.nullable.JsonNullable.<java.util.Set<java.lang.@jakarta.validation.constraints.NotNull String>>of(new java.util.LinkedHashSet<>());
		}
	...
	public org.openapitools.jackson.nullable.JsonNullable<java.util.List<java.lang.@jakarta.validation.constraints.NotNull String>> getNullableArray() {
		return nullableArray;
	}

	public void setNullableArray(org.openapitools.jackson.nullable.JsonNullable<java.util.List<java.lang.@jakarta.validation.constraints.NotNull String>> newNullableArray) {
		this.nullableArray = newNullableArray;
	}

	public org.openapitools.jackson.nullable.JsonNullable<java.util.Set<java.lang.@jakarta.validation.constraints.NotNull String>> getNullableSet() {
		return nullableSet;
	}

	public void setNullableSet(org.openapitools.jackson.nullable.JsonNullable<java.util.Set<java.lang.@jakarta.validation.constraints.NotNull String>> newNullableSet) {
		this.nullableSet = newNullableSet;
	}
